...
urlpatterns = [
    ...
    url(r'^courses/destroy/$', views.course_vm_setup, name='course_vms'),
#    url(r'^courses/(?P<course_id>[0-9]+)/destroy/$', views.course_destroy, name='course_destroy'),
    url(r'^courses/upload/$', views.upload_iso, name='upload_iso'),
]
