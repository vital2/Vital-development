...
proxy.xenapi.register_vm('richiedjohnson@yahoo.co.in', 'Test123!', '1_3_1', "3_1")  # <<studentid_courseid_vmid>>

print "Stopping vm if exists..."
proxy.xenapi.stop_vm('richiedjohnson@yahoo.co.in', 'Test123!', '1_3_1')

print "Starting VM..."
vm = proxy.xenapi.start_vm('richiedjohnson@yahoo.co.in', 'Test123!', '1_3_1')
pprint(vm)
...
proxy.xenapi.unregister_vm('richiedjohnson@yahoo.co.in', 'Test123!', '1_3_1')
